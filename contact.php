<?php
// Sauvegarder les données dans un fichier log pour diagnostic
$log = date('d/m/Y H:i:s') . "\n";
$log .= "NOM: " . ($_POST['nom'] ?? 'vide') . "\n";
$log .= "TEL: " . ($_POST['tel'] ?? 'vide') . "\n";
$log .= "TRANSPORT: " . ($_POST['transport'] ?? 'vide') . "\n";
$log .= "FICHIER VITALE: " . (isset($_FILES['vitale']) ? $_FILES['vitale']['name'] : 'aucun') . "\n";
$log .= "---\n";
...
$envoye = mail($destinataire, $sujet, $body, $headers);
file_put_contents(__DIR__ . '/log.txt', "EMAIL ENVOYE: " . ($envoye ? 'OUI' : 'NON') . "\n---\n", FILE_APPEND);
